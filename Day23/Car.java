...
public class Car {
	...
	public static final List<Car> cars = Arrays.asList(new Car("소나타,", true, 18, 210000),
			...
			new Car("아반테,", true, 10, 70000), new Car("에쿠스", false, 6, 100000), new Car("그랜저,", true, 5, 80000),
			new Car("소나타", false, 2, 35000), new Car("쏘렌토,", true, 1, 10000), new Car("아반테", false, 1, 7000));
}
