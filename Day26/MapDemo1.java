...
public class MapDemo1 {
	...
	public static void main(String[] args) {
		...
		Stream<String> s2 = s1.map(String::toUpperCase); // toUpperCase : 대문자로 바꾸기
		...
		IntStream i3 = s4.mapToInt(Integer::parseInt); // integer로 바꾸기

		Stream<String> s5 = i3.mapToObj(i -> "b" + i); // obj로 바꾸기
